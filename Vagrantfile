...
FORWARD_DOCKER_PORTS = ENV['FORWARD_DOCKER_PORTS'] || 1
...
Vagrant::Config.run do |config|
  ...
  #config.vm.box_url = "base-precise64"
...
if !FORWARD_DOCKER_PORTS.nil?
  ...
  Vagrant::VERSION >= "1.1.0" and Vagrant.configure("2") do |config|
    ...
    config.vm.network :forwarded_port, :host => 8502, :guest => 8502
    config.vm.network :forwarded_port, :host => 8555, :guest => 8555
